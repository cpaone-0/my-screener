# ==========================================================
# xStock Screener (Tokenized Stocks) - BULLISH (Daily + 4H Combined)
...
#   most convincing signal (your bigger-trend and timing timeframes agree).
#
...
def export_html(df, filename="reports/xstock_bullish_screener_results.html"):
